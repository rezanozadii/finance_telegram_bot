...
return [
    ...
    'btn_delete'            => '🗑 Delete',
    'btn_rename'            => '✏️ Rename',
    'btn_skip_note'         => '⏭ Skip note',
    'btn_edit_category'     => '✏️ Category',
    ...
    'btn_type_card'         => '💳 Card',
    'btn_type_bank'         => '🏦 Bank',
    'btn_type_ewallet'      => '📱 E-Wallet',
    'btn_type_credit'       => '💸 Credit',
    // Account actions
    ...
    'btn_view_friends'      => '👥 Friends',
    'btn_log_expense'       => '💸 Log Shared Expense',
    'btn_settle_up'         => '✅ Settle Up',
    'btn_settle_confirm'    => '✅ Settle up',
    'btn_i_paid'            => '🙋 I paid',
    'btn_they_paid'         => '🙋 :name paid',
    'btn_wants_friends'     => ':name wants to be friends',
    // Goal / Budget actions
    'btn_add_goal'          => '➕ Add Goal',
    'btn_add_budget'        => '➕ Add Budget',
    'btn_period_monthly'    => '📅 Monthly',
    'btn_period_weekly'     => '📆 Weekly',
    'btn_period_yearly'     => '🗓 Yearly',
    // Recurring actions
    'btn_add_recurring'     => '➕ Add Recurring',
    'btn_freq_daily'        => '📅 Daily',
    'btn_freq_weekly'       => '📅 Weekly',
    'btn_freq_monthly'      => '📅 Monthly',
    'btn_freq_yearly'       => '📅 Yearly',
    'btn_reminder_1'        => '1 day before',
    'btn_reminder_2'        => '2 days before',
    'btn_reminder_3'        => '3 days before',
    'btn_no_reminder'       => '🔕 No reminder',
    'btn_log_it'            => '✅ Log it',
    'btn_edit_amount'       => '✏️ Edit amount',
    'btn_deactivate'        => '🔴 Deactivate',
    'btn_confirm_deactivate'=> '✅ Yes, deactivate',
    // Category actions
    'btn_add_category'      => '➕ Add Category',
    'btn_manage'            => '✏️ Manage',
    'btn_skip_icon'         => '⏭ Skip (no icon)',
    'btn_no_parent'         => '— None (top-level)',
    'btn_change_icon'       => '🎨 Change Icon',
    'btn_confirm_delete'    => '✅ Yes, delete',
    'btn_back_list'         => '« Back to list',
    // Misc labels
    'txn_uncategorized'     => 'Uncategorized',
